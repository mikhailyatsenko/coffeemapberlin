...
### Виртуализация
- **Мобильная версия**: горизонтальная прокрутка с фиксированными размерами; при первом показе во вкладке (без сохранённой позиции и без `prefers-reduced-motion`) список один раз подсказывает свайп — сдвигается на 80px и возвращается
